  ...
  $('form#mcsubscribe')
    ...
    .bind("ajax:error", function(evt, xhr, status, error){
      ...
      try {
        ...
        errors = {message: "Будь ласка, перезавантажте сторінку і спробуйте ще раз"};
      }

      // Build an unordered list from the list of errors
      errorText = "Помилка під час відсилання. Будь ласка, перезавантажте сторінку і спробуйте ще раз.";
      errorList = "<ul>"
      for ( error in errors ) {
